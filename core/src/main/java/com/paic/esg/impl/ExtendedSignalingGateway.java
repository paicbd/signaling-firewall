...
public class ExtendedSignalingGateway extends Thread {
  ...
  private static final Logger logger = Logger.getLogger(ExtendedSignalingGateway.class);
  ...
  public static ExtendedSignalingGateway initialize(final String[] args) {
    ...
    final InputStream log4jConfiguration = new ExtendedResource("log4j.xml").getAsStream();
