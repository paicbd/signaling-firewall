...
public class XmlConfiguration {
    ...
    private Logger logger = Logger.getLogger(XmlConfiguration.class);
    ...
    private void readCDRConfiguration(Document document) {
        ...
        for (int temp = 0; temp < cdrNodeList.getLength(); temp++) {
            ...
            if (element.hasAttribute("operationsTypes")) {
                if (element.getAttribute("operationsTypes").equals("*")) {
                    cdrSettingLocal.setAllOperationsTypes(true);
                } else {
                    cdrSettingLocal.setOperationsTypes(Arrays.asList(element.getAttribute("operationsTypes").split(",")));
                }
            }
